...
public class VardaParadisana : MonoBehaviour {
	...
	//text okjekts, kurā attēlos tekstu pēc pogas nospiešanas
	public GameObject tekstaAttelosana;
	//Masīvs ar iespējamiem teksta sākumiem
	private string[] varianti = {"Sveiki ", "Labdien ", "Prieks Tevi redzēt ", "Uzredzēšanos "};
